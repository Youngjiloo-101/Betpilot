          ...
          <div className="mx-auto mt-16 max-w-2xl rounded-xl bg-primary-800/20 p-8">
            ...
            <AnimatedText delay={0.3}>
              <p className="text-gray-300 mb-6">
                Founded in Accra, Ghana, BetPilot is designed to transform the betting experience by combining advanced statistical modeling 
                and intuitive tools to help you make more informed betting decisions. We're proud to showcase African technological innovation
                on the global stage.
              </p>
            </AnimatedText>
            ...
            <AnimatedText delay={0.5}>
              <p className="text-gray-300 mb-6">
                BetPilot is proudly developed by a team of talented Ghanaian engineers, data scientists, and betting analysts.
                Our mission is to create world-class technology that showcases African innovation while solving real problems
                for bettors globally.
              </p>
            </AnimatedText>
